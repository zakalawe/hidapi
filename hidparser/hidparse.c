...
int hid_parse_report(uint8_t* rdesc_buf, uint32_t rdesc_size, hid_item** item)
{
         ...
         else if (type == 1)
         {
            ...
            */
            ...
            case HID_USAGE_MINIMUM_ITEM:
                set_local_minimum(HID_USAGE_ITEM, value);
                break;

            case HID_USAGE_MAXIMUM_ITEM:
                set_local_maximum(HID_USAGE_ITEM, value);
                break;
